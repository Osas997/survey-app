...
<form action="{{ route('sekolah.tambahGuru') }}" method="post">
    ...
    <div class="lg:grid lg:grid-cols-1 lg:place-items-center mt-10">
        <div class="mb-3 lg:w-5/12">
            ...
            <input type="text" autocomplete="off" id="nuptk" name="nuptk" placeholder="nuptk guru" class="bg-slate-50 border-2 border-blue-500 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5
                @error('nuptk')
        ...
        <div class="mb-3 lg:w-5/12">
            ...
            <input type="text" autocomplete="off" id="nama" name="nama" placeholder="Nama Guru " class="bg-slate-50 border-2 border-blue-500 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5
                @error('nama')
                    border-red-500 text-red-900 placeholder-red-700 focus:ring-red-500 focus:border-red-500
                @enderror">
            @error('nama')
