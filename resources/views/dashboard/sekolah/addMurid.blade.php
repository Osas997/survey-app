...
<form action="{{ route('sekolah.tambahMurid') }}" method="post">
    @csrf
    <div class="lg:grid lg:grid-cols-1 lg:place-items-center mt-10">
        <div class="mb-3 lg:w-5/12">
            ...
            <input type="text" autocomplete="off" id="nisn" name="nisn" placeholder="Nisn Murid" class="bg-slate-50 border-2 border-blue-500 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5
                @error('nisn')
        ...
        <div class="mb-3 lg:w-5/12">
            ...
            <input type="text" autocomplete="off" id="nama_murid" name="nama_murid" placeholder="Nama Murid" class="bg-slate-50 border-2 border-blue-500 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5
                @error('nama_murid')
                    border-red-500 text-red-900 placeholder-red-700 focus:ring-red-500 focus:border-red-500
                @enderror">
            @error('nama_murid')
        ...
        <div class="mb-3 lg:w-5/12">
            ...
            <input type="text" autocomplete="off" id="alamat" name="alamat" placeholder="Jl. Raya.. " class="bg-slate-50 border-2 border-blue-500 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5
                @error('alamat')
                    border-red-500 text-red-900 placeholder-red-700 focus:ring-red-500 focus:border-red-500
                @enderror">
            @error('alamat')
