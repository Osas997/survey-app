...
<div class="flex justify-start items-center gap-5">
   ...
   <p class="font-bold text-lg my-0">
      <span class=" md:text-xl">Edit Guru</span>
   </p>
</div>
<form action="{{ route('sekolah.updateGuru', $guru->id) }}" method="post">
   @method('put')
   @csrf
   <div class="lg:grid lg:grid-cols-1 lg:place-items-center mt-10">
      <div class="mb-3 lg:w-5/12">
         ...
         <input type="text" id="nuptk" value="{{ $guru->nuptk }}" name="nuptk" placeholder="nuptk guru" class="bg-slate-50 border-2 border-blue-500 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5
                @error('nuptk')
      ...
      <div class="mb-3 lg:w-5/12">
         ...
         <input type="text" id="nama" value="{{ $guru->nama }}" name="nama" placeholder="Nama Guru " class="bg-slate-50 border-2 border-blue-500 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5
                @error('nama')
                    border-red-500 text-red-900 placeholder-red-700 focus:ring-red-500 focus:border-red-500
                @enderror">
         @error('nama')
      ...
      <div class="mb-3 lg:w-5/12">
         ...
         <select id="gender" name="jenis_kelamin" required
            ...
            <option @if ($guru->jenis_kelamin == 'l' || $guru->jenis_kelamin == 'L') selected @endif value="l">Laki Laki
            </option>
            <option @if ($guru->jenis_kelamin == 'p' || $guru->jenis_kelamin == 'p') selected @endif
