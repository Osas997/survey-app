    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
      <div class="grid grid-cols-1 gap-4">
        <div class="bg-blue-400 w-full rounded-xl px-4 py-6 shadow-md">
          <p class="text-white">Jumlah Aktif Murid {{auth("sekolah")->user()->nama_sekolah }}</p>
          <h1 class="text-white font-bold text-4xl lg:text-5xl">224</h1>
        </div>
        <div class="bg-red-400 w-full rounded-xl px-4 py-6 shadow-md">
          <p class="text-white">Jumlah Korban Perundungan {{auth("sekolah")->user()->nama_sekolah }}</p>
          <h1 class="text-white font-bold text-4xl lg:text-5xl">304</h1>
        </div>
        <div class="bg-gray-400 w-full rounded-xl px-4 py-6 shadow-md">
          <p class="text-white">Jumlah Pelaku Perundungan {{auth("sekolah")->user()->nama_sekolah }}</p>
      ...
      <div class="max-w-full bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:p-6">
          ...
          <div>
              <h5 class="leading-none text-2xl font-bold text-gray-900 dark:text-white pb-2">Korban </h5>
              <p class="text-base font-normal text-gray-500 dark:text-gray-400">korban bebarapa periode</p>
          </div>
          </div>
      ...
      <div class="max-w-full bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:p-6">
          <div class="flex justify-between">
          <div>
              <h5 class="leading-none text-2xl font-bold text-gray-900 dark:text-white pb-2">Pelaku </h5>
              <p class="text-base font-normal text-gray-500 dark:text-gray-400">Pelaku pada beberapa periode</p>
          </div>
          </div>
