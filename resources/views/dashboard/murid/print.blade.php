    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div>
            ...
            <div class="">
                ...
                {{-- <p>Interpretasi : Memiliki kecenderungan menjadi pelaku bullying <span
                        class="text-amber-400">Sedang</span></p>
                <p>Interpretasi : Memiliki kecenderungan menjadi pelaku bullying <span
                        class="text-orange-400">Tinggi</span></p>
                <p>Interpretasi : Memiliki kecenderungan menjadi pelaku bullying <span class="text-red-400">Sangat
                        Tinggi</span></p> --}}
                <p>Interpretasi : Memiliki kecenderungan menjadi Korban bullying : <span>Rendah</span></p>
                {{-- <p>Interpretasi : Memiliki kecenderungan menjadi Korban bullying <span
                        class="text-amber-400">Sedang</span></p>
                <p>Interpretasi : Memiliki kecenderungan menjadi Korban bullying <span
                        class="text-orange-400">Tinggi</span></p>
                <p>Interpretasi : Memiliki kecenderungan menjadi Korban bullying <span class="text-red-400">Sangat
                        Tinggi</span></p> --}}
            </div>
        </div>
        <table>
