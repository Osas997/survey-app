            ...
            <div class="w-full flex justify-center items-center flex-col bg-gray-50 shadow-lg max-w-sm rounded-md py-8">
                <div class="flex justify-between  flex-col">
                    ...
                    <div class="deskirbsi px-12">
                        <h1 class="text-center text-base text-green-400 mb-16">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nam, assumenda?</h1>
                    </div>
                    <div class="flex justify-start items-start flex-col border-t-2 border-gray-200 px-4 py-4 gap-2">
                        <div class="flex justify-start items-start gap-2">
                            ...
                            <p class="text-base">12 Respon</p>
                        </div>
                        <div class="flex justify-start items-start gap-2">
                            <div class="w-7 h-7 ml-1">
                                <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M10.125 8.875C10.125 7.83947 10.9645 7 12 7C13.0355 7 13.875 7.83947 13.875 8.875C13.875 9.56245 13.505 10.1635 12.9534 10.4899C12.478 10.7711 12 11.1977 12 11.75V13" stroke="#1C274C" stroke-width="1.5" stroke-linecap="round"></path> <circle cx="12" cy="16" r="1" fill="#1C274C"></circle> <path d="M22 12C22 16.714 22 19.0711 20.5355 20.5355C19.0711 22 16.714 22 12 22C7.28595 22 4.92893 22 3.46447 20.5355C2 19.0711 2 16.714 2 12C2 7.28595 2 4.92893 3.46447 3.46447C4.92893 2 7.28595 2 12 2C16.714 2 19.0711 2 20.5355 3.46447C21.5093 4.43821 21.8356 5.80655 21.9449 8" stroke="#1C274C" stroke-width="1.5" stroke-linecap="round"></path> </g></svg>
                            </div>
                            <p class="">28 Pertanyaan</p>
                        </div>
                        <a href="" class="w-full py-4 bg-green-400 flex justify-center items-center rounded-xl mt-4 hover:bg-green-500 duration-300 ease-in-out">
