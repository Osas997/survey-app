<nav class="bg-white border-gray-200 dark:bg-gray-900">
   <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
      <a href="{{route('murid.dashboard')}}" class="flex items-center">
         <img src="{{ asset('assets/img/blue-logo.png') }}" class="h-8 mr-3" alt="Safe Schools" />
      ...
      <div class="items-center justify-between hidden w-full md:mr-16 md:flex md:w-auto md:order-1" id="navbar-user">
         <ul
            class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            <li>
               <a href="{{ route('murid.dashboard') }}" class="@if (Request::is('murid/dashboard*'))
                  bg-blue-700 md:text-blue-700 text-white
              @endif
                  block py-2 pl-3 pr-4 rounded md:bg-transparent text-gray-600 md:p-0 md:dark:text-blue-500"
                  aria-current="page">Home</a>
            </li>
            <li>
               <a href="{{ route('murid.laporan') }}" class="@if (Request::is('murid/laporan*'))
                  bg-blue-700 md:text-blue-700 text-white
              @endif
                  block py-2 pl-3 pr-4 rounded md:bg-transparent text-gray-600 md:p-0 md:dark:text-blue-500"
