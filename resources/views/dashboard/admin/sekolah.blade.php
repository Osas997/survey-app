...
<div id="toast-danger" class="flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
    ...
    <div class="ml-3 text-sm font-normal">Sekolah Berhasil di deleted.</div>
...
{{-- upload exel --}}
<div class="mt-4">
    <form action="{{ route('admin.sekolahExel') }}" method="post" enctype="multipart/form-data">
        @csrf
        ...
        <div class="flex flex-wrap items-center justify-start gap-4">
            <input
                ...
                id="file_input" name="sekolah_exel" type="file" />
            <button type="submit"
