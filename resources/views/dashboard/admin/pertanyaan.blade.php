...
<div class="min-h-screen max-h-full bg-white mx-8 my-8 border border-black rounded-[40px] p-10 ">
    ...
    <div class="flex justify-center items-start gap-2 mt-10 flex-col md:flex-row  ">
        <input type="text" placeholder="Search Pertanyaan" class="input input-bordered border-black input-md w-full max-w-xs bg-transparent h-12 "  />
