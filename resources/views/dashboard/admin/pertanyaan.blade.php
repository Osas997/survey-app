...
<div class="flex justify-center items-start gap-2 mt-10 flex-col">
    <form action="" method="get">
        <div class="relative ">
            ...
            <button type="submit"
                class="text-white absolute right-2.5 bottom-2.5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 hover:bg-blue-600 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 ">Search</button>
        </div>
    ...
    <div class="md:flex md:justify-center md:items-center  md:flex-row md:gap-4 min-w-full sm:min-w-fit ">
        <a href="">
            <div class="bg-[#0062CE] rounded-lg flex justify-center items-center px-8 w-full h-12 mt-4 hover:bg-blue-600 duration-300 ease-in-out ">
        ...
        <a href="">
            <div class="bg-red-500 rounded-lg flex justify-center items-center gap-3 w-full px-8 h-12 mt-4 hover:bg-red-600 duration-300 ease-in-out">
    ...
    <div class="">
        <div class="flex justify-between items-start gap-16">
            ...
            <div class="flex justify-center items-center flex-col gap-2 mt-5 md:mt-0">
                <a href="">
                    <div class="bg-[#0062CE] rounded-lg flex justify-center items-center  w-12 h-12 hover:bg-blue-600 duration-300 ease-in-out ">
                ...
                <a href="">
                    <div class="bg-red-500 rounded-lg flex justify-center items-center  w-12 h-12 mb-4 hover:bg-red-600 duration-300 ease-in-out">
                        <span class="text-white whitespace-nowrap sr-only text-xs">Tambah Pertanyaan</span>
                        <div class="w-8 h-8">
                            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#000000">
                                <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
