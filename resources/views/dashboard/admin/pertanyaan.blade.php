...
@section('content')
    <div class="flex justify-start items-center gap-5">
        ...
        <p class="font-bold text-lg my-0">
            <span class=" md:text-xl">Survey 1</span>
        </p>
    </div>
    <div class="flex justify-center items-start gap-2 mt-10 flex-col">
        ...
        <div class="md:flex md:justify-center md:items-center  md:flex-row md:gap-4 min-w-full sm:min-w-fit ">
            <div class="bg-[#0062CE] rounded-lg flex justify-center items-center px-8 w-full h-12 mt-4 ">
            ...
            <div class="bg-red-500 rounded-lg flex justify-center items-center gap-3 w-full px-8 h-12 mt-4 ">
    ...
    <div class="mt-8 w-full  overflow-x-hidden overflow-y-auto">
        <div class="">
            <div class="flex justify-center items-start gap-5">
                <span>1</span>
                <p class="text-black text-sm md:text-base lg:text-lg">Lorem ipsum dolor sit amet consectetur. Gravida
                    convallis viverra parturient diam dui tortor sed ullamcorper. Pulvinar neque blandit lectus amet sed
                    nisl elit nulla felis. Facilisi placerat arcu enim nunc tortor mauris amet dapibus.</p>
                <div class="flex justify-center items-center flex-col gap-2 mt-5 md:mt-0">
                    ...
                    <div class="bg-red-500 rounded-lg flex justify-center items-center  w-12 h-12 mb-4">
                        <span class="text-white whitespace-nowrap sr-only text-xs">Tambah Pertanyaan</span>
                        <div class="w-8 h-8">
                            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#000000">
                                <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
        ...
        <div class="">
            <div class="flex justify-center items-start gap-5">
                <span>1</span>
                <p class="text-black text-sm md:text-base lg:text-lg">Lorem ipsum dolor sit amet consectetur. Gravida convallis viverra parturient diam dui tortor sed ullamcorper. Pulvinar neque blandit lectus amet sed nisl elit nulla felis. Facilisi placerat arcu enim nunc tortor mauris amet dapibus.</p>
                <div class="flex justify-center items-center flex-col gap-2 mt-5 md:mt-0">
                    <div class="bg-[#0062CE] rounded-lg flex justify-center items-center  w-12 h-12 ">
                        <span class="text-white whitespace-nowrap sr-only text-xs">Tambah Pertanyaan</span>
                        <div class="w-8 h-8">
