  ...
  <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
    <div class="grid grid-cols-1 gap-4">
      <div class="bg-blue-400 w-full rounded-xl px-4 py-6 shadow-md">
        ...
        <h1 class="text-white font-bold text-4xl lg:text-5xl">524</h1>
      </div>
      ...
      <div class="flex justify-between items-start w-full">
          ...
          <button id="dateRangeButton" data-dropdown-toggle="dateRangeDropdown" data-dropdown-ignore-click-outside-class="datepicker" type="button" class="inline-flex items-center text-blue-700 dark:text-blue-600 font-medium hover:underline">Sekolah<svg class="w-3 h-3 ml-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
              <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/>
              </svg>
          </button>
          <div id="dateRangeDropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-40  dark:bg-gray-700 dark:divide-gray-600">
