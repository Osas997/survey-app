    ...
    <form action="" method="post">
        ...
        <div class="lg:grid lg:grid-cols-1 lg:place-items-center mt-10">
            <div class="mb-6 lg:w-5/12">
                ...
                <input type="text" id="nama_pertanyaan" name="namaPertanyaan" placeholder="Seberapa.. " class="bg-slate-50 border-2 border-blue-500 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
            </div>
            <div class="mb-6 lg:w-5/12">
                <div class="">
                    <label for="deskribsi" class="block mb-2 text-sm font-medium text-gray-900">Deskripsi Pertanyaan</label>
                    <textarea id="deskribsi" rows="4" name="DeskripsiPertanyaan" class="block p-2.5 w-full text-sm text-gray-900 bg-slate-50 border-2 border-blue-500 rounded-lg focus:ring-blue-500 focus:border-blue-500" placeholder="Pertanyaan ini mengenai... "></textarea>
                </div>
            </div>
        </div>
