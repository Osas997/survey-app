...
@section('content')
    ...
    Pelaku Bullying: Diki memiliki kecenderungan menjadi pelaku bullying yang tinggi. Hal ini dapat disebabkan oleh beberapa faktor, seperti lingkungan, pertemanan, atau pengalaman pribadi.
    Korban Bullying: Diki memiliki kecenderungan menjadi korban bullying yang rendah. Hal ini dapat disebabkan oleh beberapa faktor, seperti kepercayaan diri, kemampuan sosial, atau dukungan dari orang-orang terdekat. --}}
        ...
        <div>
            ...
            <div class="">
                    ...
                    <div class="text-base sm:text-1xl mb-1">Interpretasi : 
                        <ul class="list-disc pl-10">
                            <li class="text-base sm:text-1xl mb-1"> {{ auth('murid')->user()->nama_murid }} memiliki kecenderungan menjadi pelaku bullying yang 
                                @if ($dataLaporan->skor_total_pelaku >= 46)
                            ...
                            <li class="text-base sm:text-1xl mb-1"> {{ auth('murid')->user()->nama_murid }} memiliki kecenderungan menjadi Korban bullying yang 
                                @if ($dataLaporan->skor_total_korban >= 46)
